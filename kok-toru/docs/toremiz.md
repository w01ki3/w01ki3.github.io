...
- Somut Tüzük İhlali Şartı
    - Bir üye, "hoşuma gitmiyor", "bana ters yaptı" gibi soyut gerekçelerle görevden alınamaz. Yalnızca yazılı töremizde açıkça belirtilmiş bir kuralın ihlal edilmesi gerekir.
...
- Rıza ve Sınır İlkesi
    ...
    - İki üye arasında rızaya dayalı duygusal bir ilişki başlaması halinde, bu durum birim sorumlusuna şeffaflıkla bildirilmek zorundadır.
    - ​Taraf olan üyeler, objektif karar almayı engellememek adına aynı grupta veya teşkilat içindeki merkez yönetimde ast-üst olarak görev yapamazlar (olabiliyorsa birim değişikliği uygulanır).
    - ​İlişkinin teşkilat işleyişini, karar mekanizmalarını bozması, haksız kayırma yaratması veya ilişki bittiğinde teşkilata husumet taşınması durumunda her iki taraf da teşkilattan uzaklaştırılır.
- Hiyerarşik Güç Kullanma Yasağı
    - Yöneticilerin, alt kademedeki üyelerle özel mesajlarda teşkilat gücünü kullanarak sohbet başlatması, baskı kurması veya hesap sorması yasaktır.
- Şeffaflık Standartları
    - Resmi görevler, emirler ve süreçler sadece gruplardan yürütülür. Özel mesajlar (DM) tamamen kişisel ve gönüllü insani diyalog alanıdır; teşkilat işlerine kılıf yapılamaz.
- Sıfır Tolerans
...
- İşlevsel Görev Tanımları
    - Ünvanlar yerine ne iş yapıldığı tanımlanır: Saha Operasyon Sorumlusu, Eğitim İçerik Yöneticisi, Dış İlişkiler Koordinatörü, Medya Sorumlusu vb.
- Kişisel Markalaşma Yasağı
    - Üyeler, teşkilatın imkanlarını ve faaliyetlerini kendi kişisel sosyal medya hesaplarında "şahsi PR" aracı olarak kullanamazlar. Öne çıkarılan şey "şahıs" değil, "kurum ve fikir"dir.
- Ortak Akıl Söylemi
    - Açıklamalar, bildiriler ve sosyal medya paylaşımları "Ben" diliyle değil, teşkilatın ortak aklını temsil eden "Biz" diliyle yapılır.
...
- Siyasi Organ Organik Bağ Yasağı
    - Teşkilat, hiçbir siyasi partinin gençlik kolları, yan kuruluşu veya arka bahçesi olamaz. Aktif siyasi parti yöneticileri teşkilatta idari rol alamaz.
- Gündem Bağımsızlığı
